...
- On a high level, clerk promises an overall user management solution instead of just authentication with things like User Profile, Banning, Mimicing, all built in. But in practice, I've just personally had an great time using Clerk for Expo instead of Firebase/Supabase.
